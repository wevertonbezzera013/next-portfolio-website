...
export const ContactSection = () => {
    ...
    return (
        <section className="py-24 pb-48 px-6 md:py-32 flex flex-col items-center justify-center">
            <div className="relative flex place-content-center">
                <div className="absolute">
                    <div className="bg-contact items-center rounded-full w-[361px] h-[920px] md:w-[650px] md:h-[650px]"></div>
                </div>
                <Image
                ...
                <div className="w-full max-w-[420px] mx-auto">
                    <span className="font-krona text-center items-center text-lg">
                        Did you like what you see? Let's have a chat! Send me an
                        e-mail.
                    </span>
                    <Image
                        src="/images/profile-illustration.svg"
